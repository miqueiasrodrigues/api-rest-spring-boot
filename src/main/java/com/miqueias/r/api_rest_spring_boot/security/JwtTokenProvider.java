package com.miqueias.r.api_rest_spring_boot.security;

import com.auth0.jwt.JWT;
import com.auth0.jwt.JWTVerifier;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.miqueias.r.api_rest_spring_boot.exception.InvalidJwtAuthenticationException;
import com.miqueias.r.api_rest_spring_boot.vo.v1.security.TokenVO;
...
public class JwtTokenProvider {
    ...
    private String getRefreshToken(String username, List<String> roles, Date now) {
        Date validateRefreshToken = new Date(now.getTime() + validityInMilliseconds * 3);
